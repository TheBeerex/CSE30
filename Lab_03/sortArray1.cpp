...
int main(){
    ...
    if(increasing){
        cout << "The array is already sorted in ascending order." << endl; //and don't bother sorting
    }else{
    ...
    cout << "}" << endl << "The algorithm selected the minimum for the traverse of the array.";
